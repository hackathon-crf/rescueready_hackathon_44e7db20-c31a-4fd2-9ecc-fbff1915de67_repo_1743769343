...
from frontend.quizz import display_quiz
...
def handle_user_interaction():
    ...
    # Utiliser on_change pour détecter l'appui sur "Entrée"
    user_input = st.text_input("Tapez un message...", key="user_input", on_change=send_message)
